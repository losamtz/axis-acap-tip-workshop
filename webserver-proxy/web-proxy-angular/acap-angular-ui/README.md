...
The app uses Angular standalone components (no `AppModule`) and is configured for static/subpath hosting via `baseHref: "./"`. And has no routing.
...
*** This will not work if you have routing ***
